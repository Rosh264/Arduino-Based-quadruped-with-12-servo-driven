...
void loop() {
  ...
  if (autoMode) {
    ...
    switch(cmd) {
      case 'F': stepFwd(1); break;
      case 'B': stepBack(1); break;
      case 'L': turnLeft(1); break;
      case 'R': turnRight(1); break;
      case 'S': break;
      case '1': stand(); cmd = 'S'; break;
      case '2': sit(); cmd = 'S'; break;
      case '3': handWave(3); cmd = 'S'; break;
      case '4': handShake(3); cmd = 'S'; break;
      case '5': bodyDance(5); cmd = 'S'; break;
      case '6': headUp(30); cmd = 'S'; break;
      case '7': headDown(30); cmd = 'S'; break;
      case '8': bodyLeft(15); cmd = 'S'; break;
      case '9': bodyRight(15); cmd = 'S'; break;
      case 'A': autoMode = true; cmd = 'S'; break;
      case 'M': autoMode = false; cmd = 'S'; break;
    }
  }
}
